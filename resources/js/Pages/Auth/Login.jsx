                            ...
                            <form onSubmit={submit} className="space-y-5">
                                <div className="space-y-1.5">
                                    ...
                                    <Input
                                        ...
                                        required
                                        className="h-11 rounded-xl border-slate-200/90 bg-white shadow-inner shadow-slate-900/[0.02] transition-[box-shadow,border-color] focus-visible:border-[var(--theme-primary)]/40 focus-visible:ring-[var(--theme-primary)]/25"
                                    ...
                                    <div className="flex items-center justify-between gap-2">
                                        ...
                                        {canResetPassword && (
                                            <Link
                                                ...
                                                className="text-xs font-medium text-[var(--theme-primary)] hover:text-[var(--theme-primary-hover)] hover:underline"
                                            >
                                                Forgot password?
                                            </Link>
                                        )}
                                ...
                                <div className="flex items-center gap-2">
                                    <Checkbox
                                        ...
                                        className="border-slate-300 data-[state=checked]:border-[var(--theme-primary)] data-[state=checked]:bg-[var(--theme-primary)]"
                                    />
                                    <Label
                                        htmlFor="remember"
                                ...
                                <Button
                                    type="submit"
                                    disabled={processing}
                                    className="h-11 w-full rounded-xl bg-[var(--theme-primary)] text-base font-semibold shadow-lg shadow-[#1e3a5f]/25 transition hover:bg-[var(--theme-primary-hover)] hover:shadow-xl hover:shadow-[#1e3a5f]/30"
                                >
