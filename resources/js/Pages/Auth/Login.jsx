            ...
            >
                <div className="relative flex min-h-0 flex-1 flex-col overflow-y-auto overscroll-y-contain px-10 py-12 xl:px-14 2xl:px-20">
                    <div className="mx-auto my-auto w-full max-w-2xl space-y-12 lg:mx-0 xl:max-w-3xl 2xl:max-w-4xl">
                        <header className="flex flex-col gap-6 border-b border-white/15 pb-10 sm:flex-row sm:items-end sm:justify-between sm:gap-8">
                            <div className="flex items-center gap-4">
                                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-white/10 ring-1 ring-white/20 backdrop-blur sm:h-16 sm:w-16">
                                    <GraduationCap className="h-8 w-8 text-white sm:h-9 sm:w-9" strokeWidth={1.65} />
                                </div>
                                <div>
                        ...
                        <div className="grid gap-10 xl:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] xl:items-start xl:gap-x-14 xl:gap-y-0">
                ...
                <footer className="relative shrink-0 border-t border-white/10 px-10 py-5 xl:px-14 2xl:px-20">
                    <p className="text-xs text-slate-400/95">Copyright {new Date().getFullYear()} TALAIS</p>
                </footer>
            </aside>

            <main className="relative z-[1] flex min-h-0 w-full min-w-0 flex-1 flex-col overflow-y-auto overscroll-y-contain px-4 py-10 sm:px-6 lg:h-full lg:flex-[3] lg:px-10 lg:py-12 xl:px-14 2xl:px-16">
                <div className="mx-auto my-auto w-full max-w-[28rem] space-y-8">
                    ...
                    <div className="space-y-2 text-center sm:text-left">
                        ...
                        <p className="text-sm leading-relaxed text-slate-600">
                            Use the email <span className="whitespace-nowrap">or mobile number</span> you registered with,
                            plus your password.
                        </p>
                    </div>
                        ...
                        <CardContent className="space-y-6 p-6 sm:p-8">
                            ...
                            <form onSubmit={submit} className="space-y-5">
                                <div className="space-y-1.5">
                                    ...
                                    />
                                    {errors.login && <p className="text-xs text-red-600">{errors.login}</p>}
                                </div>
